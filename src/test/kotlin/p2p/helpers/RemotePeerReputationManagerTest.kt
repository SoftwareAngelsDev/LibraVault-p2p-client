...
class RemotePeerReputationManagerTest {
    ...
    private val testPeer1 = ByteArray(512) { 1 }  // Filled with 1's
    private val testPeer2 = ByteArray(512) { 2 }  // Filled with 2's
    private val testPeer3 = ByteArray(512) { 3 }  // Filled with 3's
    ...
    fun testGetKnownRemotePeersWithMultiplePeers() = runTest {
        ...
        assertTrue(peers.any { it.key.contentEquals(testPeer1) }, "Should contain testPeer1")
        assertTrue(peers.any { it.key.contentEquals(testPeer2) }, "Should contain testPeer2")
        assertTrue(peers.any { it.key.contentEquals(testPeer3) }, "Should contain testPeer3")
    }
    ...
    fun testBlockAndUnblockPeer() = runTest {
        ...
        assertTrue(blockedPeers[0].remotePeerId.contentEquals(testPeer1), "Blocked peer should be testPeer1")
